...
public class ClsUsuario {
    ...
    public Date getUltima_sesion_usuario() {
     ...
     public void setUltima_sesion_usuario_util(java.util.Date ultima_sesion_usuario_util) {
        this.ultima_sesion_usuario = new java.sql.Date(ultima_sesion_usuario_util.getTime());
    }
