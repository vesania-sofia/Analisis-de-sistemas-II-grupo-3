 ...
 * @author sofia
 */
public class Listado_Video extends javax.swing.JDialog {

    /**
     * Creates new form Listado_Video
     */
    public Listado_Video(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "TITULO", "PRECIO", "AÑO DE ESTRENO", "GENERO", "ACTORES", "SINTESIS", "IMAGEN", "NUMERO DE COPIA", "FORMATO"
            }
        ));
        ...
        jLabel1.setText("LISTADO DE VIDEOS");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel1Layout.createSequentialGroup()
                    ...
                    .addGap(383, 383, Short.MAX_VALUE)))
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Listado_Video.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Listado_Video dialog = new Listado_Video(new javax.swing.JFrame(), true);
