    ...
    ventana.setVisible(true);*/
     ...
     if (Txt_usuario.getText().trim().isEmpty() || Txt_contraseña.getText().trim().isEmpty()) {
            ...
            try {
                ...
                usuario.setNombre_usuario(Txt_usuario.getText().trim());
                // Recuperación de información a través de otro objeto
                usuario = usuario.getBuscarInformacionRentaPorNombre(usuario);
                if (Txt_contraseña.getText().equals(usuario.getContraseña_usuario()) && 
                    Txt_usuario.getText().equals(usuario.getNombre_usuario())) {
