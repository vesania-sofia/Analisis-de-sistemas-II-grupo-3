...
public class Login_Administrador extends javax.swing.JFrame {
    ...
    if (Txt_admin.getText().trim().isEmpty() || Txt_contraseña.getText().trim().isEmpty()) {
            ...
            try {
                ...
                admin.setNombreUsuario(Txt_admin.getText().trim());
                // Recuperación de información a través de otro objeto
                admin = admin.getBuscarAdministradorPorNombre(admin);
                if (Txt_contraseña.getText().equals(admin.getContraAdmin()) && 
                    Txt_admin.getText().equals(admin.getNombreAdmin())) {
