 ...
 * @author sofia
 */
public class Registro_Video extends javax.swing.JDialog {

    /**
     * Creates new form Registro_Video
     */
    public Registro_Video(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "DVD" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registro_Video.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Registro_Video dialog = new Registro_Video(new javax.swing.JFrame(), true);
